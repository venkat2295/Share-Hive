...
import { deletePost, getUserPosts } from "../../../../services/index/posts";
import { toast } from "react-hot-toast";
import { Link } from "react-router-dom";
import { useDataTable } from "../../../../hooks/useDataTable";
import DataTable from "../../components/DataTable";

const UserManagePosts = () => {
  const {
    userState,
    currentPage,
    searchKeyword,
    ...
    dataQueryFn: () => getUserPosts(userState.userInfo.token, searchKeyword, currentPage),
